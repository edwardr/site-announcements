		...
		if( $a ):
			...
			if( !$user_hidden ) {
				if( '' == $announcement->content ) {
					$name = '' == $announcement->url ? '<h4 style="color: ' . $announcement->text_color . '">' . $announcement->name . '</h4>' : '<a href="' . esc_url( $announcement->url ) . '"><h4 class="cw-announcement-title">' . $announcement->name . '</h4></a>';
				} else {
